...
def _main():
    ...
    model = create_model(input_shape, anchors, num_classes,weights_path='model_data/yolo_weights.h5')
    train_num = 0
    model_name = 'yolov3_20181024_taishi_'
    ...
    #第二阶段多尺度训练
    muti_scales=[(288,288),(416,416),(608,608),(288,288),(416,416),(608,608)]
...
def train(model, annotation_path_train,annotation_path_val, input_shape, anchors, num_classes,save_model_name,log_dir='logs/'):
    ...
    # model.save(log_dir + save_model_name)
