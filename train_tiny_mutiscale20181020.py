...
def _main():
    ...
    train_num = 0
    model_name='yolov3_tiny_20181020_'
    ...
    #第二阶段多尺度训练
    muti_scales=[(416,416),(608,608),(288,288),(416,416),(608,608),(288,288),(416,416)]
    ...
    for input_shape in muti_scales:
        ...
        model = create_tiny_model(input_shape, anchors, num_classes,
                                  freeze_body=2, weights_path=log_dir+open_model_name)
...
def train(model, annotation_path_train,annotation_path_val, input_shape, anchors, num_classes,save_model_name,log_dir='logs/'):
    ...
    early_stopping = EarlyStopping(monitor='val_loss', min_delta=0, patience=8, verbose=2)  # 验证集准确率，下降前终止
    batch_size = 32
