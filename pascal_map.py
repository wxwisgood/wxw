...
currentPath=currentPath+"\mAP\Object-Detection-Metrics-master"
...
def com_mAP_own_folder(dict_mAP,detections_foldername='detections'):
    ...
    dict_mAP['mAP'] = round(mAP * 100, 3)
    return dict_mAP
#将yolo输出的结果解析保存到对应txt文档中
def write_txt(out_boxes, out_scores, out_classes,f1,class_names):
