...
class YOLO(object):
    _defaults = {
        ...
        "score" : 0.5,
        "iou" : 0.5,#交并比小于此参数认为是另外一个目标，值越大，输出目标越多，越小，输出目标越少
    ...
    def del_boundary_object(self,image,boxes, scores, classes):
        ...
        while (i < len(classes)):
            ...
            boundary_stutas = False  # 是否在边界上
            boundary_hid = 4  # 离边界多近就在边界上
    ...
    def com_object_stutas(self,image,out_boxes, out_scores, out_classes):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            position_score=1-max(pianyi_x,pianyi_y)#采用街区距离
